        ...
        <div className="prose prose-slate prose-sm max-w-none space-y-6 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              registration forms, you grant SETX Youth Football Camp and its
              respective affiliates, partners, and successors a non-exclusive,
              perpetual, irrevocable, royalty-free, worldwide license to
              collect, store, use, process, analyze, transfer, and otherwise
              handle any and all data and information submitted for any lawful
              purpose.
            </p>
            <p>
