 ...
 * accent-bordered link block. Sharp edges throughout.
 */
...
const JoinCallout = () => (
  <section className="relative overflow-hidden border-b border-ds-border bg-ds-bg py-24 sm:py-32 lg:py-40">
    <div aria-hidden="true" className="absolute -right-32 top-10 h-96 w-96 rounded-full bg-ds-accent-soft blur-[160px]" />
    <div aria-hidden="true" className="absolute -left-20 bottom-0 h-80 w-80 rounded-full bg-primary-500/20 blur-[160px]" />
    ...
    <div className="relative mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-10">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr] lg:gap-20">
        ...
        <Reveal variant="right" delay={2} className="flex flex-col justify-end gap-6">
          ...
          <Link
            to={REGISTER_PATH}
            className="mono-tag inline-flex items-center justify-center gap-2 border border-ds-accent bg-ds-accent px-6 py-5 text-white transition-colors duration-200 hover:bg-ds-accent-bright hover:border-ds-accent-bright"
          >
