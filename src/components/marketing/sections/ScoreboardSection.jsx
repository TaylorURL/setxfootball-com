 ...
 * grid with very large numerals and a short label for each fact.
 */
    ...
    <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-10">
      <div className="grid grid-cols-2 divide-x divide-ds-border border-x border-ds-border sm:grid-cols-4">
        {HERO_STATS.map((stat) => (
          ...
          >
            <span className="editorial-display mono-num text-5xl text-ds-accent-bright sm:text-6xl lg:text-7xl">
              {stat.value}
            </span>
